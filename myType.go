...
func (e *Encoder) myType(v *MyType) (err os.Error){
     ...
     if _, _, error := e.t.PointerCheck(unsafe.Pointer(v), "76eb37ac7238b996b688185e8217dd9adbfa0ab975128f2058e4a8c3b86175f805ae833a989fe1a7a4db129665a65b4c00090d57bca7538b510e5c83cfe4f638", uint64(unsafe.Sizeof(*v))); error == nil {
...
func (e *Encoder) any(a Any) (err os.Error){
     ...
     case MyType:
     	hashByte, err := hex.DecodeString("76eb37ac7238b996b688185e8217dd9adbfa0ab975128f2058e4a8c3b86175f805ae833a989fe1a7a4db129665a65b4c00090d57bca7538b510e5c83cfe4f638")
	if err != nil {
	   return err
	}
     	// hashByte := []byte("76eb37ac7238b996b688185e8217dd9adbfa0ab975128f2058e4a8c3b86175f805ae833a989fe1a7a4db129665a65b4c00090d57bca7538b510e5c83cfe4f638")
     	// e.string("76eb37ac7238b996b688185e8217dd9adbfa0ab975128f2058e4a8c3b86175f805ae833a989fe1a7a4db129665a65b4c00090d57bca7538b510e5c83cfe4f638")
...
func (d *Decoder) any() (retValue *Any, error os.Error) {
     ...
     case bytes.Equal(encodedHash, []byte("76eb37ac7238b996b688185e8217dd9adbfa0ab975128f2058e4a8c3b86175f805ae833a989fe1a7a4db129665a65b4c00090d57bca7538b510e5c83cfe4f638")):
...
func (t *MyType) CreateDirectory(path string, label string) (syscall.Status) {
       hash := goodmiddleman.HashValue{ 0x76,0xeb,0x37,0xac,0x72,0x38,0xb9,0x96,0xb6,0x88,0x18,0x5e,0x82,0x17,0xdd,0x9a,0xdb,0xfa,0x0a,0xb9,0x75,0x12,0x8f,0x20,0x58,0xe4,0xa8,0xc3,0xb8,0x61,0x75,0xf8,0x05,0xae,0x83,0x3a,0x98,0x9f,0xe1,0xa7,0xa4,0xdb,0x12,0x96,0x65,0xa6,0x5b,0x4c,0x00,0x09,0x0d,0x57,0xbc,0xa7,0x53,0x8b,0x51,0x0e,0x5c,0x83,0xcf,0xe4,0xf6,0x38, }
       return goodmiddleman.CreateDirectory(path, label, hash)
}


func (t *MyType) GetHash() ([]byte) {
       return []byte{ 0x76,0xeb,0x37,0xac,0x72,0x38,0xb9,0x96,0xb6,0x88,0x18,0x5e,0x82,0x17,0xdd,0x9a,0xdb,0xfa,0x0a,0xb9,0x75,0x12,0x8f,0x20,0x58,0xe4,0xa8,0xc3,0xb8,0x61,0x75,0xf8,0x05,0xae,0x83,0x3a,0x98,0x9f,0xe1,0xa7,0xa4,0xdb,0x12,0x96,0x65,0xa6,0x5b,0x4c,0x00,0x09,0x0d,0x57,0xbc,0xa7,0x53,0x8b,0x51,0x0e,0x5c,0x83,0xcf,0xe4,0xf6,0x38, }
}
type Int8 int8
