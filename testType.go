...
func (e *Encoder) testType(v *TestType) (err os.Error){
     
     if _, _, error := e.t.PointerCheck(unsafe.Pointer(v), "755a044cb38c4c123249d2065d4050d878397d02b182d66a3fa87886b1128cecdf5c355bc7e2ae133c4ea9d5c26a4d208d0590274a16ac3026c480546f9b692d", uint64(unsafe.Sizeof(*v))); error == nil {
...
func (e *Encoder) testTypeInternal(v *TestType) (err os.Error){
...
func (d *Decoder) testType() (v *TestType, error os.Error){
...
func (d *Decoder) testTypeInternal() (v *TestType, error os.Error){
...
func (e *Encoder) any(a Any) (err os.Error){
     ...
     case TestType:
     	hashByte, err := hex.DecodeString("755a044cb38c4c123249d2065d4050d878397d02b182d66a3fa87886b1128cecdf5c355bc7e2ae133c4ea9d5c26a4d208d0590274a16ac3026c480546f9b692d")
	if err != nil {
	   return err
	}
     	// hashByte := []byte("755a044cb38c4c123249d2065d4050d878397d02b182d66a3fa87886b1128cecdf5c355bc7e2ae133c4ea9d5c26a4d208d0590274a16ac3026c480546f9b692d")
     	// e.string("755a044cb38c4c123249d2065d4050d878397d02b182d66a3fa87886b1128cecdf5c355bc7e2ae133c4ea9d5c26a4d208d0590274a16ac3026c480546f9b692d")
...
func (d *Decoder) any() (retValue *Any, error os.Error) {
     ...
     case bytes.Equal(encodedHash, []byte("755a044cb38c4c123249d2065d4050d878397d02b182d66a3fa87886b1128cecdf5c355bc7e2ae133c4ea9d5c26a4d208d0590274a16ac3026c480546f9b692d")):
...
func (t *TestType) IpcWrite(serviceName string, hostname string) (syscall.Fd, syscall.Status) {
	serviceFd, status := goodmiddleman.OpenDirectory("/services/" + serviceName)
	if status != syscall.StatusOk {
		log.Fatalf ("Error calling OpenDirectory /services/%s: %v\n", serviceName, status)
		return 0, status
	...
	if status != syscall.StatusOk {
		log.Fatalf ("Error calling IpcWriteTestType: %v\n", status)
		return 0, status
	}
...
func (t *TestType) Write(fd syscall.Fd) (syscall.Status) {
...
func (t *TestType) WriteBuffer() ([]byte, syscall.Status) {
...
func (t *TestType) WriteVar(path string) (syscall.Status) {
...
func (t *TestType) Read(fd syscall.Fd) (syscall.Status) {
	d := NewDecoder(goodmiddleman.NewReader(fd))

	value, err := d.TestType()
	if err != nil {
...
func (t *TestType) ReadBuffer(buffer []byte) (syscall.Status) {
...
func (t *TestType) ReadVar(path string) (syscall.Status) {
	fd, name, status := goodmiddleman.OpenPathLastDirectory(path)
	if status != syscall.StatusOk {
		return status
	}
...
func (t *TestType) CreateDirectory(path string, label string) (syscall.Status) {
       hash := goodmiddleman.HashValue{ 0x75,0x5a,0x04,0x4c,0xb3,0x8c,0x4c,0x12,0x32,0x49,0xd2,0x06,0x5d,0x40,0x50,0xd8,0x78,0x39,0x7d,0x02,0xb1,0x82,0xd6,0x6a,0x3f,0xa8,0x78,0x86,0xb1,0x12,0x8c,0xec,0xdf,0x5c,0x35,0x5b,0xc7,0xe2,0xae,0x13,0x3c,0x4e,0xa9,0xd5,0xc2,0x6a,0x4d,0x20,0x8d,0x05,0x90,0x27,0x4a,0x16,0xac,0x30,0x26,0xc4,0x80,0x54,0x6f,0x9b,0x69,0x2d, }
       return goodmiddleman.CreateDirectory(path, label, hash)
}


func (t *TestType) GetHash() ([]byte) {
       return []byte{ 0x75,0x5a,0x04,0x4c,0xb3,0x8c,0x4c,0x12,0x32,0x49,0xd2,0x06,0x5d,0x40,0x50,0xd8,0x78,0x39,0x7d,0x02,0xb1,0x82,0xd6,0x6a,0x3f,0xa8,0x78,0x86,0xb1,0x12,0x8c,0xec,0xdf,0x5c,0x35,0x5b,0xc7,0xe2,0xae,0x13,0x3c,0x4e,0xa9,0xd5,0xc2,0x6a,0x4d,0x20,0x8d,0x05,0x90,0x27,0x4a,0x16,0xac,0x30,0x26,0xc4,0x80,0x54,0x6f,0x9b,0x69,0x2d, }
}
type Int8 int8
